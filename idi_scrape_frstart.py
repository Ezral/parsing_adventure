...
# Page selection
# driver.find_element_by_link_text("787").click()
...
# write to csv
df.to_csv('/Users/medicalagent3/idi_member_part1_{}.csv'.format(now))
# Printing process time
proc_time = time.time() - start
print("/Users/medicalagent3/idi_member_part1_{}.csv saved in /Users/medicalagent3/".format(now))
